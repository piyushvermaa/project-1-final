  ...
  return (
    <figure
      className={cn(
        ...
        // light styles
        "border-black/[.5] bg-gradient-to-r from-[#826040b5] to-[#433324b5] hover:bg-gray-950/[.05] ",
        // dark styles
        "dark:border-black/[.5] dark:bg-gradient-to-r dark:from-[#826040b5] dark:to-[#3f3329e0] dark:hover:bg-[#5f4a36db]"
      )}
    >
