      ...
      <div className="w-full relative h-full  bg-cover bg-[top] text-left text-[1.25rem] text-gray1-300 font-lobster-two justify-center items-center" style={{ backgroundImage: "url(/bg.png)" }}>
        ...
        <div className="flex flex-wrap justify-center mt-[12rem] pb-12 gap-8 px-4">
          <div className="relative w-[19.125rem]">
            ...
            <div className="absolute top-[26rem] left-[3.5rem] shadow-md rounded-lg bg-[#a18424] w-[11.875rem] h-[3.438rem] flex items-center justify-center py-[0.375rem] px-[1.5rem] box-border font-space-grotesk">
              <div className="relative font-medium">enroll</div>
            </div>
          </div>

          <div className="relative w-[19.125rem]">
            <img className="w-full h-[33.75rem] object-contain" alt="" src="/vector-32.svg" />
            <div className="absolute top-0 left-0 w-full h-full bg-gray-700 opacity-0" />
            <div className="absolute top-[20rem] left-[2rem] text-black text-center inline-block w-[12.688rem] h-[3.125rem]">
